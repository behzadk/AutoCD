	...
	dV_1T =   +  kV_max_1T  * ( A_2**n_A_V_1T / ( K_A_V_1T**n_A_V_1T  + A_2**n_A_V_1T) ) - ( V_1T  * ( ( mu_max_1 * S_glu / ( K_mu_glu + S_glu ) ) / 2 ) ) - ( k_TV_ann * T_1T * V_1T ) +  kV_max_1T  * ( A_1**n_A_V_1T / ( K_A_V_1T**n_A_V_1T  + A_1**n_A_V_1T) ) - ( V_1T  * ( ( mu_max_2 * S_glu / ( K_mu_glu + S_glu ) ) / 2 ) )

	dT_1T =   +  kT_max_1T  * ( A_1**n_A_T_1T / ( K_A_T_1T**n_A_T_1T  + A_1**n_A_T_1T) ) - ( T_1T  * ( ( mu_max_1 * S_glu / ( K_mu_glu + S_glu ) ) / 2 ) ) - ( k_TV_ann * T_1T * V_1T )

	dT_2T =   +  kT_max_2T  * ( A_2**n_A_T_2T / ( K_A_T_2T**n_A_T_2T  + A_2**n_A_T_2T) ) - ( T_2T  * ( ( mu_max_2 * S_glu / ( K_mu_glu + S_glu ) ) / 2 ) )
