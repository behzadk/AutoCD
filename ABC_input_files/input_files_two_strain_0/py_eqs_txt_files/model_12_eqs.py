	...
	dB_1 = ( - D * B_1 ) +  kB_max_1  * ( (C_extra * A_1)**n_A_B_1 / ( K_A_B_1**n_A_B_1 + (C_extra * A_1)**n_A_B_1 ) ) * N_1 * C_OD / C_extra  +  kB_max_1  * ( (C_extra * A_2)**n_A_B_1 / ( K_A_B_1**n_A_B_1 + (C_extra * A_2)**n_A_B_1 ) ) * N_2 * C_OD / C_extra 
